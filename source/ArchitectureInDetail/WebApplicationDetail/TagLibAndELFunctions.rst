...
* ページネーションリンクのレイアウトの変更方法については、「:ref:`pagination_how_to_use_make_view_layout`」
...
\ ``f:query()``\ の使用方法については、「:ref:`pagination_how_to_use_make_view_basic_search_criteria`」を参照されたい。
