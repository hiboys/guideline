...
| すべての要素はSpring Data提供のページ検索機能で実現することができる。ページ検索機能については、「:ref:`ページ検索について <pagination_overview_page_search>` 」を参照されたい。
...
| Spring Data提供のページ検索機能を使用することで、以下の情報を画面に表示することが容易となる。
