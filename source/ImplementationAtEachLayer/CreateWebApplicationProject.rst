...
.. code-block:: console
    ...
    (... omit)
    [INFO] ----------------------------------------------------------------------------
    [INFO] Using following parameters for creating project from Archetype: macchinetta-multi-web-blank-archetype:1.5.0.RELEASE
    [INFO] ----------------------------------------------------------------------------
...
.. list-table::
    ...
    * - | (1)
      - Maven Archetypeで作成したプロジェクト。
        ...
        version 1.5.0.RELEASE用のMaven Archetypeで作成したプロジェクトでは、
