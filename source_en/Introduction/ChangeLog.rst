...
.. list-table::
    ...
    * - 2017-XX-XX
      - \-
      - 5.3.2 RELEASE version published

        * For details of update, refer \ `Issue list of 5.3.2 <https://github.com/terasolunaorg/guideline/issues?utf8=%E2%9C%93&q=label%3A5.3.2%20is%3Aissue%20is%3Aclosed%20>`_\.

    * -
      - General
      - Correction of guideline mistakes (typing errors, simple mistakes, etc.)  
  
        * For details of the correction,please refer \ `5.3.2's Issue list (clerical error) <https://github.com/terasolunaorg/guideline/issues?utf8=%E2%9C%93&q=%20label%3A5.3.2%20is%3Aclosed%20label%3A%22clerical%20error%22%20>`_\.

        Description details improved

        * For details of the improvement、please refer \ `5.3.2's Issue list(improvement) <https://github.com/terasolunaorg/guideline/issues?utf8=%E2%9C%93&q=label%3A5.3.2%20label%3Aimprovement%20is%3Aclosed%20>`_\.
